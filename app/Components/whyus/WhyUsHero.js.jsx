  ...
  return (
    <section className="relative pt-20 md:pt-24 h-96 sm:h-[500px] lg:h-[600px]">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/Whyus/bg.jpg')",
        }}
      >
      ...
      <div className="relative z-10 h-full flex items-center justify-center">
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Building <span className="text-[#001C73] font-bold">excellence and trust</span> through decades of construction expertise
          </motion.p>
          ...
          >
            {[
              { text: "25+ Years Experience", icon: <FaStar className="w-3 h-3" /> },
              { text: "500+ Projects", icon: <FaBolt className="w-3 h-3" /> },
              { text: "99% Satisfaction", icon: <FaClock className="w-3 h-3" /> }
            ].map((item, index) => (
              <motion.div 
                key={index}
